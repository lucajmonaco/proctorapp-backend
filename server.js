...
function sendPage(res, file) {
  ...
  return res.sendFile(path.join(__dirname, 'public', 'pages', file));
}

app.get('/share/:token', (req, res) => sendPage(res, 'submit.html'));
app.get('/submit/:token', (req, res) => sendPage(res, 'submit.html'));
